...
@section('content')
    <div class="columns m-t-10 m-l-10">
        ...
        <div class="column m-t-20 is-three-fifths">
            <form action="{{route('surfing.store')}}" method="post">
                {{ csrf_field() }}
                <b-field class="m-b-0" label="Заголовок серфинга"
                        ...
                        @endif>
                    <b-input placeholder="Заголовок" name="name" maxlength="100"></b-input>
                </b-field>
                ...
                <input type="submit" class="button is-primary m-t-10 m-b-30" value="Добавить серфинг">
            </form>
        </div>
        <div class="column">
