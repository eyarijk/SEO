                        ...
                        <article class="media ">
                            ...
                            <div class="media-content">
                                <form method="post" action="/manage/task/buy/">
                                    ...
                                    <div class="content">
                                        <b-field label="Задание: {{$tasks->name}}">
                                        ...
                                        <span class="button m-l-5">Цена за шт: {{$tasks->salary*1.2}} ₽</span>
                                    </div>
                                </form>
                            </div>
                        </article>
...
@section('scripts')
    <script>
        var app = new Vue({
            ...
            watch: {
                salary: function (val) {
                    this.total = 'С счёта будет списано: ' + (val * 1.2 * {{$tasks->salary}}).toFixed(2) + ' ₽'
                },
            }
