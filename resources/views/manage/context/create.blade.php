        ...
        <div class="column m-t-20 is-three-fifths">
            <form action="{{route('contexts.store')}}" method="post">
                ...
                <b-field label="Описание"
                    ...
                    @endif>
                    <b-input placeholder="Краткое описание..." maxlength="200" name="description" type="textarea"></b-input>
                </b-field>
                ...
                <input type="submit" class="button is-primary m-t-10 m-b-30" value="Добавить">
            </form>
        </div>
        <div class="column">
